...
public class GuessNumberGameV5 {
    ...
    public static void guessAverage() {
        ...
        Double doubleCount = new Double(count);
        Double doubleNum=new Double(num);
        System.out.println("Average = " + doubleNum/doubleCount);  //แสดงค่าเฉลี่ยของเลขที่สุ่ม
    }
    ...
    public static void guessMin() {
        ...
        System.out.println("Min = " + least);  //แสดงค่าน้อยที่สุดของเลขที่สุ่ม
    }
    ...
    public static void guessMax()  {
        ...
        System.out.println("Max = " + most);  //แสดงค่ามากที่สุดของเลขที่สุ่ม
    }
